...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      const response = await axios.post(
        "http://python.bhandarishishir.com.np/api/auth/login/",
        {
          email,
          password,
        }
  ...
  const register = async (username, email, password) => {
    try {
      await axios.post(
        "http://python.bhandarishishir.com.np/api/auth/register/",
        {
          username,
          email,
          password,
  ...
  const changePassword = async (password) => {
    try {
      const response = await axios.post(
        "http://python.bhandarishishir.com.np/api/auth/changepassword",
        {
          password,
        }
      );
  ...
  const searchProduct = async (name) => {
    try {
      const response = await axios.post(
        "http://python.bhandarishishir.com.np/search",
        {
          title: name,
        }
      );
